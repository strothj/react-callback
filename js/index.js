...
var SoundCloudEmbed = function(props) {
    ...
    return <iframe width="100%" height="450" scrolling="no" src={src} style={{ border: 0 }}></iframe>;
};
...
document.addEventListener('DOMContentLoaded', function() {
    ReactDOM.render(<Suprise />, document.getElementById('app'));
});
